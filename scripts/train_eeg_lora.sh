...
for i in {1..1}; do
    ...
    # Experiment name (wandb name)
    exp_name="${sub_id}"

    # Paths
    checkpoints_dir="./checkpoints/"
    # Save to subject-specific folder to avoid overwriting
    bed_path="./eeg_lora_checkpoints/${sub_id}/"
    mkdir -p "$bed_path"
    ...
    # EEG data paths
    # Use subject-specific quantization file
    ...
    echo -e "\033[1;32mFinished training for ${sub_id}\033[0m"
done

echo -e "\033[1;32mAll trainings completed!\033[0m"
